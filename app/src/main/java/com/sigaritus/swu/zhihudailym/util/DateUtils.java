...
public class DateUtils {
    ...
    /**Returns xxxx年x月x日 */
    public static String getDayAsString(Calendar calendar,boolean yesterday){

        int day = yesterday?calendar.get(Calendar.DAY_OF_MONTH)-1:calendar.get(Calendar.DAY_OF_MONTH);
        int month = calendar.get(Calendar.MONTH) + 1;
        int year = calendar.get(Calendar.YEAR);
